...
- **[SCRIPTS_README.md](SCRIPTS_README.md)** - Документация по скриптам и утилитам
...
- **[ROLE_SYSTEM_UPDATE.md](ROLE_SYSTEM_UPDATE.md)** - Система ролей игроков
- **[ROLE_CACHING_AND_NAMES.md](ROLE_CACHING_AND_NAMES.md)** - Кеширование ролей и имен
- **[BAN_SYSTEM.md](BAN_SYSTEM.md)** - Система банов пользователей
- **[RISK_ANALYSIS_IMPROVEMENTS.md](RISK_ANALYSIS_IMPROVEMENTS.md)** - Улучшения анализа риска

### 🔍 Функциональность поиска
- **[UUID_SEARCH_README.md](UUID_SEARCH_README.md)** - Поиск игроков по UUID
- **[UUID_PROCESSING_README.md](UUID_PROCESSING_README.md)** - Обработка UUID и обновление имен
- **[HIDDEN_PLAYER_NOTIFICATIONS.md](HIDDEN_PLAYER_NOTIFICATIONS.md)** - Уведомления скрытых игроков

### 🛠️ Административные инструменты
- **delete_user_data.py** - Скрипт для удаления всех данных пользователя из базы данных
- **merge_databases.py** - Скрипт для объединения баз данных

### 📢 Публикации
- **[TELEGRAM_POST.md](TELEGRAM_POST.md)** - Пост для Telegram канала
...
### Анализ игроков:
- `/court <ник или UUID>` — Получить полную информацию о судебных делах игрока
...
### Полезные ссылки:
- **Telegram**: @K1zik
- **GitHub**: https://github.com/SlidrusForeal/SPworlds-court-bot/
